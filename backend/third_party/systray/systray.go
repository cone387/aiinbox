...
// SetOnLeftClick sets a callback that is invoked when the user left-clicks
// the tray icon. If not set, left-click shows the menu (same as right-click).
func SetOnLeftClick(f func()) {
	systrayLeftClick = f
}
